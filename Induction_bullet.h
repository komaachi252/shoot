...
//	ƒvƒƒgƒ^ƒCƒvéŒ¾
//™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™
void Induction_Bullet_Init(void);	//‰Šú‰»ŠÖ”
void Induction_Bullet_Uninit(void);	//I—¹ˆ—ŠÖ”
void Induction_Bullet_Update(void);	//XVˆ—
void Induction_Bullet_Draw(void);    //•`‰æˆ—
...
Circle* Induction_Bullet_Get_Collision(int index); // ’†g‘‚«Š·‚¦‚È‚¢ƒAƒs[ƒ‹‚ÅƒRƒ“ƒXƒg‚Â‚¯‚é
